...
//     axios.post('http://localhost:8001/Test', formData)
//       .then(response => {
...
//   //     const response = await axios.post('http://localhost:8001/Test', formData, {
//   //       headers: {
...
//                 <h1 className="text-center font-extrabold text-4xl mt-10 mb-10">Take a <span className="text-[rgb(18,102,241)]">Skin Test</span></h1>
//                 <p className="text-center font-bold text-2xl mt-2 mb-5">Get a Preliminary Diagnosis by taking skin test</p>
...
//                     </div>
//                     <input onChange={handleFileChange} name="image" accept="image/*" id="image-upload" type="file" className="hidden" />
//                     </label>
//                 </div>
//                 <div className="flex items-center justify-center m-2 w-full">
//                     {loadedImage && <img src={loadedImage} id="output" width="200" alt="Selected" />}
//                 </div>
...
//                 {disease && (
//                 <div className="mt-5">
//                     <h1 className="text-xl mt-5 text-center">Disease Detected</h1>
//                     <div className="w-full mt-5 bg-green-100 border border-blue-400 text-green-700 px-4 py-3 rounded relative" role="alert">
//                     <span className="block sm:inline text-center"><strong>{disease}</strong></span>
//                     </div>
//                 </div>
//                 )}
//             </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="md:w-8/12 justify-center p-3 lg:ml-2 lg:w-5/12">
                    ...
                    <div className="mt-2">
                        ...
                        <span className="block sm:inline text-center"><strong>{prediction}</strong></span>
                        </div>
                    </div>
                    )}
              </div>
